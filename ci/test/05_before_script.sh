...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Arcadia
else
  DOCKER_EXEC echo \> \$HOME/.arcadia
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/arcadia/arcadia/pull/18288#discussion_r433189350 for
  # details.
