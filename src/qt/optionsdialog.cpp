    ...
    mapper(nullptr)
{
    ...
    ui->arcadiaAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->arcadiaAtStartup);
    ...
    ui->arcadiaAtStartup->setToolTip(ui->arcadiaAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->arcadiaAtStartup->setText(ui->arcadiaAtStartup->text().arg(PACKAGE_NAME));

    ui->openArcadiaConfButton->setToolTip(ui->openArcadiaConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new ArcadiaUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->arcadiaAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openArcadiaConfButton_clicked()
{
