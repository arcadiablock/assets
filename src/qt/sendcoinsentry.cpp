    ...
    platformStyle(_platformStyle)
{
    ...
    // normal arcadia address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying arcadia address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &ArcadiaAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
