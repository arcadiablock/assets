...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, ArcadiaGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &ArcadiaGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &ArcadiaGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &ArcadiaGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &ArcadiaGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &ArcadiaGUI::updateWalletStatus);
    connect(gui, &ArcadiaGUI::setPrivacy, walletView, &WalletView::setPrivacy);
