// Copyright (c) 2019 The Arcadia Core developers
...
/* A AEAD class for ChaCha20-Poly1305@arcadia.
 *
 ...
 *
 * The chacha20-poly1305@arcadia combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@arcadia cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@arcadia are relatively fast in
