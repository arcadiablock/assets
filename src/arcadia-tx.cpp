...
static void SetupArcadiaTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " arcadia-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  arcadia-tx [options] <hex-tx> [commands]  Update hex-encoded arcadia transaction\n" +
            "or:     arcadia-tx [options] -create [commands]   Create hex-encoded arcadia transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded arcadia transaction
