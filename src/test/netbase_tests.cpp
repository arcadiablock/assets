...
{
    BOOST_CHECK(TestSplitHost("www.arcadiablock.com", "www.arcadiablock.com", -1));
    BOOST_CHECK(TestSplitHost("[www.arcadiablock.com]", "www.arcadiablock.com", -1));
    BOOST_CHECK(TestSplitHost("www.arcadiablock.com:80", "www.arcadiablock.com", 80));
    BOOST_CHECK(TestSplitHost("[www.arcadiablock.com]:80", "www.arcadiablock.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:5579", "127.0.0.1", 5579));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:5579", "127.0.0.1", 5579));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:5579", "::ffff:127.0.0.1", 5579));
    BOOST_CHECK(TestSplitHost("[::]:5579", "::", 5579));
    BOOST_CHECK(TestSplitHost("::5579", "::5579", -1));
    BOOST_CHECK(TestSplitHost(":5579", "", 5579));
    BOOST_CHECK(TestSplitHost("[]:5579", "", 5579));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:5579", "127.0.0.1:5579"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:5579", "[::]:5579"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
