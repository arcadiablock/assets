...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the ArcadiaTestFramework
    pass


class ExampleTest(ArcadiaTestFramework):
    # Each functional test is a subclass of the ArcadiaTestFramework class.
    ...
    def custom_method(self):
        ...
        ArcadiaTestFramework class so other tests can use it."""
