#!/usr/bin/env python3
# Copyright (c) 2019-2020 The Arcadia Core developers
...
class TxDownloadTest(ArcadiaTestFramework):
    ...
    def run_test(self):
        ...
        # Run each test against new arcadiad instances, as setting mocktimes has long-term effects on when
