...
class TestShell:
    """Wrapper Class for ArcadiaTestFramework.

    The TestShell class extends the ArcadiaTestFramework
    ...
    class __TestShell(ArcadiaTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by ArcadiaTestFramework child class.
            self.num_nodes = 1
