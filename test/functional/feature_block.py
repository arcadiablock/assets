...
class FullBlockTest(ArcadiaTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure arcadiad isn't accepting b26
        ...
        # Extend the b28 chain to make sure arcadiad isn't accepting b28
        ...
        # arcadiad doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the arcadia code has custom code which does so);
