...
"""Verify that starting arcadia with -h works as expected."""

from test_framework.test_framework import ArcadiaTestFramework
from test_framework.util import assert_equal

class HelpTest(ArcadiaTestFramework):
    ...
    def run_test(self):
        self.log.info("Start arcadia with -h for help text")
        ...
        self.log.info("Start arcadia with -version for version information")
        ...
        self.log.info("Start arcadiad with -fakearg to make sure it does not start")
