...
class P2PPermissionsTests(ArcadiaTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].arcadiaconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].arcadiaconf, 'w', encoding="utf8") as f:
            f.write(newText)
