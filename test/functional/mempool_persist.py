...
By default, arcadiad will dump mempool on shutdown and
...
class MempoolPersistTest(ArcadiaTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent arcadiad from writing mempool.dat to disk. Verify that `savemempool` fails")
