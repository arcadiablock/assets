# Bootstrappable Arcadia Core Builds

This directory contains the files necessary to perform bootstrappable Arcadia
Core builds.
...
- 24GB of free disk space on the partition that the Arcadia Core git repository
  resides in
...
For a Arcadia Core depends development environment, simply invoke
...
From the top of a clean Arcadia Core repository:
...
To use dongcarl's substitute server for Arcadia Core builds after having
