...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the arcadia repository."
  exit 1
fi
...
# See https://github.com/arcadia/arcadia/issues/16064
...
echo 'When compiling arcadiad, run `./configure` in the following way:'
echo
