...
This document provides guidelines for internationalization of the Arcadia Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `arcadia_en.ts` remains unchanged.
