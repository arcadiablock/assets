# Fuzzing Arcadia Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing Arcadia Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):

```sh
$ git clone https://github.com/arcadia/arcadia
$ cd arcadia/
$ ./autogen.sh
$ CC=clang CXX=clang++ ./configure --enable-fuzz --with-sanitizers=address,fuzzer,undefined
# macOS users: If you have problem with this step then make sure to read "macOS hints for
# libFuzzer" on https://github.com/arcadia/arcadia/blob/master/doc/fuzzing.md#macos-hints-for-libfuzzer
$ make
...
[`process_message`](https://github.com/arcadia/arcadia/blob/master/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/arcadia/arcadia/blob/master/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/arcadia/arcadia/tree/master/src/test/fuzz).
...
The project's collection of seed corpora is found in the [`arcadia-core/qa-assets`](https://github.com/arcadia-core/qa-assets) repo.

To fuzz `process_message` using the [`arcadia-core/qa-assets`](https://github.com/arcadia-core/qa-assets) seed corpus:

```sh
$ git clone https://github.com/arcadia-core/qa-assets
...
If you find coverage increasing inputs when fuzzing you are highly encouraged to submit them for inclusion in the [`arcadia-core/qa-assets`](https://github.com/arcadia-core/qa-assets) repo.

Every single pull request submitted against the Arcadia Core repo is automatically tested against all inputs in the [`arcadia-core/qa-assets`](https://github.com/arcadia-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make Arcadia Core more robust.
...
with certain assembly code from Arcadia Core's code. See [developer notes on sanitizers](https://github.com/arcadia/arcadia/blob/master/doc/developer-notes.md#sanitizers)
...
# Fuzzing Arcadia Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing Arcadia Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing Arcadia Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing Arcadia Core using [Honggfuzz](https://github.com/google/honggfuzz):
