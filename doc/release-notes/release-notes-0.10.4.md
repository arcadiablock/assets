Arcadia Core version 0.10.4 is now available from:

  <https://arcadia.org/bin/arcadia-core-0.10.4/>
...
- #6953 `43c2789` Split arcadia-tx into its own package
- #6953 `dfe0d4d` Include arcadia-tx binary on Debian/Ubuntu
