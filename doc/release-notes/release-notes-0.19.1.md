...
Arcadia Core version 0.19.1 is now available from:

  <https://arcadiablock.com/bin/arcadia-core-0.19.1/>
...
From Arcadia Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Arcadia Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Arcadia Core does not yet change appearance when
...
- #17488 fix "arcadiad already running" warnings on macOS (fanquake)
