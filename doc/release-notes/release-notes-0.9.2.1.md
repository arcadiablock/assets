Arcadia Core version 0.9.2.1 is now available from:

  https://arcadia.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ARC to 0.01 ARC
...
- Fix "Start arcadia on system login"
