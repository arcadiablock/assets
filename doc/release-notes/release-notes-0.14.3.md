Arcadia Core version *0.14.3* is now available from:

  <https://arcadia.org/bin/arcadia-core-0.14.3/>
...
- #10451 `3612219` contrib/init/arcadiad.openrcconf: Don't disable wallet by default (Luke Dashjr)
