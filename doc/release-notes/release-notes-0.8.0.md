Arcadia-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/arcadia/files/Arcadia/arcadia-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Arcadia
...
New/changed settings (command-line or arcadia.conf file)
--------------------------------------------------------
