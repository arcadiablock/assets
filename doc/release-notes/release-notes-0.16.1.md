Arcadia Core version 0.16.1 is now available from:

  <https://arcadiablock.com/bin/arcadia-core-0.16.1/>
...
- #12843 `df38b13` Test starting arcadiad with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure arcadiad processes are cleaned up when tests end (sdaftuar)
