Arcadia Core version 0.9.4 is now available from:

  https://arcadia.org/bin/0.9.4/
...
this update is incompatible with the Arcadia system and could lead to consensus
forks.

Arcadia Core released binaries from https://arcadia.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~arcadia/+archive/ubuntu/arcadia
- A third-party or self-compiled Arcadia Core

upgrade to Arcadia Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
