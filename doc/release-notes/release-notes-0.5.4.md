Arcadia version 0.5.4 is now available for download at:
http://sourceforge.net/projects/arcadia/files/Arcadia/arcadia-0.5.4/
...
http://gitorious.org/arcadia/arcadiad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Arcadia-Qt notifications under Growl 1.3.
Increase required age of Arcadia-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxArcadia properly when installing Arcadia-Qt over it. (Windows)
