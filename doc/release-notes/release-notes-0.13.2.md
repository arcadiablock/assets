Arcadia Core version 0.13.2 is now available from:

  <https://arcadia.org/bin/arcadia-core-0.13.2/>
...
- #8908 `4a974b2` Update arcadia-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow arcadia-tx to create v2 transactions (arcdrak)
