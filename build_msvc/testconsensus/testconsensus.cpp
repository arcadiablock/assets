...
// arcadia includes.
#include <..\src\script\arcadiaconsensus.h>
...
int main()
{
    std::cout << "arcadiaconsensus version: " << arcadiaconsensus_version() << std::endl;
    ...
    auto op0Result = arcadiaconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, arcadiaconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
